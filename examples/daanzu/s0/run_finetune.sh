...
train_set=2021-07-25/train_concat10_90train
dev_set=2021-07-25/train_concat10_10dev
finetune2_set=finetune
# Optional train_config
name=train_u2pp_conformer
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
  ...
  tools/make_raw_list.py $data/$finetune2_set/wav.scp $data/$finetune2_set/text \
    $data/$finetune2_set/data.list
fi
