...
if $uttbase; then
  ...
  local/subset_data_dir.sh --first $srcdir $N_head $trndir
  local/subset_data_dir.sh --last $srcdir $N_tail $cvdir
...
local/subset_data_dir.sh --spk-list $trndir/_tmpf_trainspk $srcdir $trndir
local/subset_data_dir.sh --spk-list $cvdir/_tmpf_cvspk $srcdir $cvdir
